...
Case 3 '======== For AU6375 sorting
   ...
   Call GPIBWrite("VSET1 3.55")
   
   Call GPIBWrite("ISET1 1.00")
    
   Call GPIBWrite("VSET2 2.5")
    
   Call GPIBWrite("ISET2 1.00")
