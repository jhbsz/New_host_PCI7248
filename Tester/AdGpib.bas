...
Dim rdbuf$
Const GPIB0 = 0
'Const WriteData = "1234567890 abcdefghijklmnopqrstuvwxyz!!!"
Dim WriteData
' initial
...
End Select
 ...
 'MsgBox rdbuf$
   ...
   'HostForm.Label32.Caption = "PWR out=" & rdbuf$
...
End Sub
Public Sub PowerOnOff(CH1_OnOff As String, CH2_OnOff As String)
...
Call GPIBWrite("OUT1 " & CH1_OnOff)
Call GPIBWrite("OUT2 " & CH2_OnOff)
...
Public Sub GPIBRead(ReadData As String)
Dim rdbuf$
Dim Status%
