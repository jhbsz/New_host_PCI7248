...
#define INT1_COS                 0    //INT1 COS : only available for PCI-7396, PCI-7256, PCI-7260
...
#define INT1_CH0				 1    //INT1 CH0 : only available for PCI7256, PCI7260
...
#define INT2_CH1				 2	  //INT2 CH1 : only available for PCI7256, PCI7260
...
//Trigger Mode
#define P9111_TRGMOD_SOFT         0x00   //Software Trigger Mode
#define P9111_TRGMOD_PRE          0x01   //Pre-Trigger Mode
#define P9111_TRGMOD_POST         0x02   //Post Trigger Mode
...
/*---------------------------------------------------------------------------*/
I16 __stdcall AI_9111_Config (U16 CardNumber, U16 TrigSource, U16 TrgMode, U16 TraceCnt);
...
I16 __stdcall WDT_Setup (U16 CardNumber, U16 wCtr, F32 ovflowSec, F32 *actualSec, HANDLE *hEvent);
I16 __stdcall WDT_Control (U16 wCardNumber, U16 wCtr, U16 action);
I16 __stdcall WDT_Status (U16 wCardNumber, U16 Ctr, U32 *pValue);
/*---------------------------------------------------------------------------*/
...
I16 __stdcall GetCardIndexFromID (U16 wCardNumber, U16 *cardType, U16 *cardIndex);
